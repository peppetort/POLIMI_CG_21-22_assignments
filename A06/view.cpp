...
glm::mat4 LookInDirMat(glm::vec3 Pos, glm::vec3 Angs) {
    ...
    glm::mat4 roll = glm::rotate(glm::mat4(1), glm::radians(Angs.z), glm::vec3(0,0,1));
    glm::mat4 elevation = glm::rotate(glm::mat4(1), glm::radians(Angs.y), glm::vec3(1,0,0));
    glm::mat4 direction = glm::rotate(glm::mat4(1), glm::radians(Angs.x), glm::vec3(0,1,0));
